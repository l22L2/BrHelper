...
if enable_autoupdate then
    ...
    if updater_loaded then
        ...
        if autoupdate_loaded then
            Update.json_url = "https://raw.githubusercontent.com/l22L2/BrHelper/main/update.json?" .. tostring(os.clock())
...
-- COMBO
	...
	local my_arr = {u8"-",u8"�����",u8"���",u8"�����",u8"����",u8"�����",u8"��",u8"���",u8"����",u8"����������� ���", u8"������������� ���", u8"������������ ���", u8"-"}
--
...
function cmd_fastlip(arg,arg2)
    ...
    if #arg == 0 then
        sampAddChatMessage(tag .. "/fsl [id] | ip ���������������",-1)
    else 
...
function cmd_fastlip2(arg,arg2)
    ...
    if #arg == 0 then
        sampAddChatMessage(tag .. "/ofsl [id] | ip ���������� �����",-1)
    else 
...
function imgui.OnDrawFrame()
	...
	if main_window_state.v then
		...
		if imgui.Button(u8'���������', imgui.ImVec2(135, 20)) then uu() menu[2] = true end imgui.SameLine()
        if imgui.Button(u8'����������', imgui.ImVec2(135, 20)) then uu() menu[3] = true end -- ���� ������� ���������, ����� �� ����� ��������� imgui.SameLine()
		imgui.Spacing()
		if menu[1] then
			imgui.Text(u8"������������� �� ���� ������ ")
			imgui.Spacing()
			...
			imgui.Spacing() 
			imgui.InputText(u8'ID ������ ', text_buffer_id)
			imgui.SameLine()
			...
			imgui.SameLine()
			imgui.Checkbox(u8"����", checked_test_2)
			imgui.SameLine()
			imgui.Checkbox(u8"�����", checked_piar_gibdd)
			imgui.SameLine()
			imgui.Checkbox(u8"���", checked_piar_fsb)	
			imgui.SameLine()
			imgui.Checkbox(u8"��", checked_piar_mo)	
			imgui.SameLine()
			imgui.Checkbox(u8"��", checked_piar_cb)	
			imgui.SameLine()
			imgui.Checkbox(u8"���", checked_piar_smi)	
			imgui.SameLine()
			imgui.Checkbox(u8"����", checked_piar_fsin)
			-- ============== ��� ======================
			imgui.SetCursorPosY(175)
			imgui.SetCursorPosX(235)
			imgui.Checkbox(u8"������", checked_piar_arz)
			imgui.SameLine()
			imgui.Checkbox(u8"���", checked_piar_bat)
			imgui.SameLine()
			imgui.Checkbox(u8"���", checked_piar_lit)
			-- =====================================================
		...
		if menu [3] then
			imgui.Text(u8"�����: NN")
			imgui.Spacing() 
			imgui.Text(u8"������: 0.1.2 TestVersion")
			imgui.Spacing()
			imgui.Text(u8"����������: ������� 'G' -  �������� ���������� ���� �� �������� ����� (/af) \n*� ��������� �� ������ ��a�� , �������� ������� ������:(")
			imgui.Spacing()
			imgui.Text(u8"�������: \n/rg - ��������� \n/fsl - �������� �� �������� (��  ���������������� ip) \n/ofsl - �������� �� �������� (�� ip ���������� �����)")
...
function set_leader()
	lua_thread.create(function()
		...
		sampSendChat("/o INFO || ������������ ��������� ������!")
		wait(5600)
		sampSendChat('/o INFO || �� ���� ������ ������� "' .. u8:decode(my_arr[combo_select.v + 1]) .. '" �������� - ' .. res)
		wait(5600)
		sampSendChat("/o INFO || ��������� � ��� - " .. buffer)
		buffer = nil
	end)
end
local name_player
